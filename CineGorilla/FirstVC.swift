...
class FirstVC: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(named: "cl")
        
        let topBackgroundView = UIView()
            topBackgroundView.backgroundColor = UIColor(named: "cl")
            topBackgroundView.translatesAutoresizingMaskIntoConstraints = false
            view.addSubview(topBackgroundView)
            
            let bottomBackgroundView = UIView()
            bottomBackgroundView.backgroundColor = UIColor(named: "cl")
